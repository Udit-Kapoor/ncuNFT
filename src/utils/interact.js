...
const alchemyKey = "https://polygon-mumbai.g.alchemy.com/v2/_vg6yVR3UUIMltj7ffyZEqPGQDrcEpRf";
...
export const mintNFT = async(url, name, description) => {
  ...
  try {
      ...
      return {
          success: true,
          status: "✅ Check out your transaction on Polyscan: https://mumbai.polygonscan.com/tx/" + txHash
      }
  } catch (error) {
      return {
          success: false,
